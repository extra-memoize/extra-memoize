import { memoizeStaleWhileRevalidateWithAsyncCache } from '@memoizes/stale-while-revalidate'
import { SWRAsyncCache } from '@test/utils'
...
describe(`
  memoizeStaleWhileRevalidateWithAsyncCache<Result, Args extends any[]>(
    options: {
      cache: ISWRAsyncCache<Result>
...
`, () => {
  it('caches the result', async () => {
    ...
    const memoizedFn = memoizeStaleWhileRevalidateWithAsyncCache({ cache }, fn)
